...
public class PumaAcitivity extends AppCompatActivity {
    private ActivityPumaAcitivityBinding binding;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        binding = ActivityPumaAcitivityBinding.inflate(getLayoutInflater());
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    if (!itemDomains.isEmpty()) {
                        binding.recyl.setLayoutManager(new GridLayoutManager(PumaAcitivity.this, 2));
