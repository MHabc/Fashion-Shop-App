...
import com.example.fashionapp.databinding.ActivityAdidasBinding;
import com.example.fashionapp.databinding.ActivityNikeBinding;
...
public class NikeActivity extends AppCompatActivity {
        ...
        private ActivityNikeBinding binding;

        @Override
        protected void onCreate(Bundle savedInstanceState) {
                super.onCreate(savedInstanceState);
                EdgeToEdge.enable(this);
                 binding=ActivityNikeBinding.inflate(getLayoutInflater());
        ...
        private void initAdidas() {
                ...
                myref.orderByChild("rating").startAt(1).endAt(2).addListenerForSingleValueEvent(new ValueEventListener() {
                        @Override
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()) {
                                        ...
                                        if (!itemDomains.isEmpty()) {
                                                binding.recyl.setLayoutManager(new GridLayoutManager(NikeActivity.this, 2));
